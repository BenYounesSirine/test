...
@Component({
  selector: 'app-ex5etudiants',
  templateUrl: './ex5etudiants.component.html',
  styleUrls: ['./ex5etudiants.component.css']
})
export class Ex5etudiantsComponent implements OnInit {
